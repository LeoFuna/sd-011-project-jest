...
describe('verifica o usuário', () => {
  // api.fetchURL = jest.fn().mockResolvedValue(mockReturnOfFetchURL);
  test('verifica se o usuário é o tunico', async () => {
    const apiFetchURL = jest.fn().mockResolvedValue(mockReturnOfFetchURL);
    const user = await apiFetchURL();

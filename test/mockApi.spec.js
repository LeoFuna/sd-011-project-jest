...
describe('verifica o usuário', () => {
  ...
  const tunicoResponse = {
    gender: 'male',
    name: { title: 'Mr', first: 'Antônio', last: 'Britto' },
    location: {
      street: { number: 1299, name: 'Avenida Tryber' },
      city: 'Belo Horizonte',
      state: 'Minas Gerais',
      country: 'Brazil',
      postcode: 16223,
    ...
    dob: { date: '1965-10-01T06:35:49.694Z', age: 35 },
  ...
  api.fetchURL = jest.fn().mockResolvedValue(tunicoResponse);

...
describe('verifica as funções e os mocks', () => {
  test('testa função add', () => {
    mockFunctions.add.mockImplementation((firstNumber, secondNumber) => firstNumber + secondNumber);
  ...
  test('testa função subtract', () => {
    mockFunctions.subtract.mockImplementation(
  ...
  test('testa função multiply', () => {
    mockFunctions.multiply.mockImplementation(
      (firstNumber, secondNumber) => firstNumber * secondNumber,
    );
  ...
  test('testa função divide', () => {
    mockFunctions.divide.mockImplementation(
      (firstNumber, secondNumber) => firstNumber / secondNumber,
    );
  ...
  test('testa função factorial', () => {
    mockFunctions.factorial.mockImplementation(
      (number) => (number === 1 ? 1 : number * mockFunctions.factorial(number - 1)),
    );

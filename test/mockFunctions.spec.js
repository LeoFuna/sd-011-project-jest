...
jest.mock('../src/mockFunctions'); // mocka todas com um só comando:
...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função add', () => {
    expect.assertions(5); // função expect sera chamada 5 vezes
    mockFunctions.add.mockImplementation((a, b) => a + b); // mockImplementation - passa um função modificada e a testa

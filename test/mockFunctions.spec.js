...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função subtract', () => {
    const subtract = jest.fn().mockImplementation((a, b) => a - b);
  ...
  test('testa função divide', () => {
    const divide = jest.fn().mockImplementation((a, b) => a / b);
  ...
  test('testa função power', () => {
    const power = jest.fn().mockImplementation((a, b) => a ** b);
  ...
  test('testa função factorial', () => {
    const factorial = jest.fn().mockImplementation((value) => {
      let fact = 1;

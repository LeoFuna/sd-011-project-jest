...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função add', () => {
    // const mockMockFunctions = jest.spyOn(mockFunctions, 'add');
    // mockMockFunctions.add = (a, b) => a + b;
    // expect(mockMockFunctions.add(1, 2)).toEqual(3);
    // expect(mockMockFunctions.add(8, 37)).toEqual(45);
    // expect(mockMockFunctions.add(-11, 25)).toEqual(14);
    // expect(mockMockFunctions.add(13, -188)).toEqual(-175);
    // expect(mockMockFunctions.add(7, 26)).toEqual(33);

...
/** A linha abaixo mocka todas as funções do arquivo mockFunctions.js */
...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função subtract', () => {
    mockFunctions.subtract.mockImplementation((a, b) => a - b); /** A alteração usando mockImplementation */
  ...
  test('testa função multiply', () => {
    mockFunctions.multiply.mockImplementation((a, b) => a * b); /** A alteração usando mockImplementation */
  ...
  test('testa função divide', () => {
    mockFunctions.divide.mockImplementation((a, b) => a / b); /** A alteração usando mockImplementation */
  ...
  test('testa função power', () => {
    mockFunctions.power.mockImplementation((a, b) => a ** b); /** A alteração usando mockImplementation */
  ...
  */
  test('testa função factorial', () => {
    mockFunctions.factorial.mockImplementation((a) => {
      ...
      return resultado;
    }); /** A alteração usando mockImplementation */
